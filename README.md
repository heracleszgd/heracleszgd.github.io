...
2. **Symmetry and Group Theory**: Classify all the ferroelectric switching paths and orthogonal domain walls in complex ferroelectrics, e.g., in [FE-HfO<sub>2</sub>](https://doi.org/10.1103/PhysRevB.106.064104)
3. **Low-Dimensional Magnetism**: [Monte Carlo](https://github.com/heracleszgd/MaCMoC) with effective spin Hamiltonian, [Ising-2DFM VI<sub>3</sub>](https://doi.org/10.1103/PhysRevB.103.014438), Janus-TMD, vdW-heterestructures, Dzyaloshinsky-Moriya interaction (DMI), Skyrmions
...
- <strong><font color=red>[NEW!]</font></strong> Nov 2022, Invited Speaking, [EEMD 2022](https://mp.weixin.qq.com/s/d5k2IqmjTE8K7xgsd2P3yg)
...
### Publications
**Pub-Top & Intro**
1. <strong><font color=red>[NEW!]</font> Symmetry of ferroelectric switching and domain walls in hafnium dioxide</strong>.  
...
2. <strong>Difference in magnetic anisotropy of the ferromagnetic monolayers VI<sub>3</sub> and CrI<sub>3</sub> [[PRBTopDownload](https://twitter.com/PhysRevB/status/1358952763871395841)]<strong>.  
   ***G.-D. Zhao***, X. Liu, T. Hu, F. Jia, Y. Cui, W. Wu, M.-H. Whangbo, and W. Ren, ***Phys. Rev. B*** 103, 014438 (2021).  
   ...
   - Accurately predicted the Curie Temperature of monolayer VI<sub>3</sub> (T<sub>C</sub> = 58\~60 K). [[Xiaodong Xu Group](https://doi.org/10.1021/acs.nanolett.1c03027)].
...
5. Structural and magnetic properties of two-dimensional layered BiFeO<sub>3</sub> from first principles.  
...
8. Two-dimensional charge density waves in TaX<sub>2</sub> (X = S, Se, Te) from first principles.  
...
13. Manipulation of valley pseudospin in WSe<sub>2</sub>/CrI<sub>3</sub> heterostructures by the magnetic proximity effect.  
...
14. Structural and electronic properties of two-dimensional freestanding BaTiO<sub>3</sub>/SrTiO<sub>3</sub> heterostructures.  
...
17. Vertical ferroelectric switching by in-plane sliding of two-dimensional bilayer WTe<sub>2</sub>.  
   X. Liu, Y. Yang, T. Hu, ***G. Zhao***, C. Chen, and W. Ren, ***Nanoscale*** 11, 18575 (2019).  
   DOI: [10.1039/C9NR05404A](https://doi.org/10.1039/C9NR05404A)
18. Magnetic and electronic properties of Cr<sub>2</sub>Ge<sub>2</sub>Te<sub>6</sub> monolayer by strain and electric-field engineering.  
...
20. First-principles studies of a two-dimensional electron gas at the interface of polar/polar LaAlO<sub>3</sub>/KNbO<sub>3</sub> superlattices.  
...
23. Thickness Control of the Spin-Polarized Two-Dimensional Electron Gas in LaAlO<sub>3</sub>/BaTiO<sub>3</sub> Superlattices.  
...
24. Structural properties and strain engineering of a BeB<sub>2</sub> monolayer from first-principles.  
